...
namespace PosService.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "idx_cash_registers_store_id",
                schema: "pos",
                table: "cash_registers",
                column: "store_id");

            migrationBuilder.CreateIndex(
                name: "idx_cash_sessions_cashier_id",
                schema: "pos",
                table: "cash_sessions",
                column: "cashier_id");

            migrationBuilder.CreateIndex(
                name: "idx_cash_sessions_register_id",
                schema: "pos",
                table: "cash_sessions",
                column: "register_id");

            migrationBuilder.CreateIndex(
                name: "idx_cash_sessions_status",
                schema: "pos",
                table: "cash_sessions",
                column: "status");

            migrationBuilder.CreateIndex(
                name: "idx_cashiers_store_id",
                schema: "pos",
                table: "cashiers",
                column: "store_id");

            migrationBuilder.CreateIndex(
                name: "idx_cashiers_username",
                schema: "pos",
                table: "cashiers",
                column: "username",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "idx_sales_cash_session_id",
                schema: "pos",
                table: "sales",
                column: "cash_session_id");

            migrationBuilder.CreateIndex(
                name: "idx_sales_cashier_id",
                schema: "pos",
                table: "sales",
                column: "cashier_id");
