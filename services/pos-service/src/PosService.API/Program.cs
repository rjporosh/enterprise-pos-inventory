...
global using SharedInfrastructure.RateLimiting;
global using SharedInfrastructure.Authentication;
...
/// <summary>
/// Exposes the top-level-statement Program class so that
/// <c>WebApplicationFactory&lt;Program&gt;</c> in the test projects can locate this
/// assembly's entry point and content root. Without this, WebApplicationFactory has no way
/// to bootstrap the real host (the auto-generated Program class is internal by default).
/// </summary>
